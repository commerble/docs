...
EC事業者がオンラインで販売を行い、顧客が決済し、指定の配送先に商品を送る、もしくはサービスを提供する一連のやり取りをEC(Electric Commerce)と呼び、極力コンパクトにしたEC形態の1つと言えるでしょう。
...
検索サービスの重要な機能の1つにファセットがあり、カテゴリ別に切り口とその件数が表示されドリルダウンしていくことが出来たり、レビュースコア別の切り口でグルーピングしたり、価格帯でグルーピングしたりなど使い勝手を高めることが可能です。
