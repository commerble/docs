...
ここでは、リリース後に売り上げを伸ばすためにやることを記載します。
本稿は、現在書いている途中です。また、項目が多岐にわたるため、今後分割する予定です。

## 売上を倍増するには

### 分析

- 指標を取得します（売上、カテゴリ、客層、PV、CVR）
...
- 得意なカテゴリ別のシナリオを仮説検証する（こういう時にこういう買い方をするのではないか）。
...
- 工具店の場合は、工具のレンタルサービスなどのサービス化を検討します。
- 中古品の取り扱いです。
