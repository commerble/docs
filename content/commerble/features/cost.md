...
- パフォーマンス
    + 作り捨てではなく、常時最速にします。
- セキュリティ
    + Commerble本体を定期的に検査実施します。各テナントのカスタマイズを含んだ部分は別途実施していただく必要があります。
- Commerbleに関する問い合わせ
- テナント共通のアップデート機能
    + 随時提供します。
    + 大半の機能でカスタマイズを⾏うため、全く無償で使えるケースは少ないですが、低コストで新しい決済などを導⼊可能になります。
- 受注増のためのアドバイス
    + 随時対応します。
...
- メール
    + お客様側でSMTPサーバーをご用意いただくか、SMTPサービスのSendGridの契約をお願いしています。
- カスタマイズ部分に関する問い合わせ
