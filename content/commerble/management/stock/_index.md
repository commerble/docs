...
+ 販売可能数のみから減らす。
+ 販売可能数を優先して減らす。販売可能数が無い場合は、外部在庫数を減らす。
+ 外部在庫数を優先して減らす。外部在庫数が無い場合は、販売可能数を減らす。
...
配送可能な在庫数は、直ぐに配送が可能な在庫数を表します。  
受注した商品に在庫引当する時は、配送可能な在庫数から引当てます。  
受注の商品が全て在庫引当済みになると、出荷作業に進みます。

*配送可能な在庫数以外の項目は、どのように扱ってもCommerbleの標準動作に影響はありません。*  
...
{{% /alert %}}
Commerbleの在庫引当処理は、受注した商品に対して**配送可能な在庫数**を引当てます。  
