...
- ただし、Commerble外のカスタマイズ部分については、別途取得を検討してください（例えば、専用の会員サイトや管理サイトを作った場合など）。この場合は、AzureのLog Analytics機能の利用を推奨しています。

### 第三者によるセキュリティ検査の⽅法（導⼊時、運⽤時）

<!-- textlint-disable ja-technical-writing/ja-no-weak-phrase -->
- Commerble側では、お客様に必要な業者を選定いただき、本番相当の環境で試験を実施していただきます。
