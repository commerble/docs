...
- ただし、Commerble外のカスタマイズ部分については、別途取得を検討する必要があります（例えば、専用の会員サイトや管理サイトを作った場合など）。この場合は、AzureのLog Analytics機能の利用を推奨しています。

### 第三者によるセキュリティ検査の⽅法（導⼊時、運⽤時）

<!-- textlint-disable ja-technical-writing/ja-no-weak-phrase -->
- Commerble側では、お客様に必要な業者を選定いただき、適切な環境で試験を実施していただきます。
- 外部ネットワークについては通常のECサイトに攻撃して頂く形で問題ありません。
- 内部ネットワークの試験に関しては他テナント様のデータもありますので、試験用環境を用意するなど、慎重に進めます。
...
- 専用の管理画面を構築する場合は、Azure内でのADやAzure ADを利用した認証を利用できますので、多要素認証付きのログイン（不正検知機能付き）に対応可能です。
