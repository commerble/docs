...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.7fccbf59e95ec3d0ffd876d34bbe790c63da3cd00e277bf20f3a067fee4c33a9.js',function(){input.required=false;search();});}
